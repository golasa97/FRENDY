#ifndef GMF05_PARSER_H
#define GMF05_PARSER_H
...
namespace frendy
{
  class GMF05Parser
  {
    ...
    public:
      ...
      vector<int>     get_IG();
      vector<vector<vector<Real> > > get_LAMDA();
      vector<vector<vector<vector<Real> > > > get_CHI();
      ...
      void set_LAMDA(vector<vector<vector<Real> > > real_vec);
      void set_CHI(vector<vector<vector<vector<Real> > > > real_vec);
  };
}

#endif // GMF05_PARSER_H
