#ifndef GMF16_PARSER_H
#define GMF16_PARSER_H
...
namespace frendy
{
  class GMF16Parser
  {
    ...
    public:
      ...
      vector<vector<vector<vector<Real> > > > get_MATRIX();
      ...
      void set_MATRIX(vector<vector<vector<vector<Real> > > > real_vec);
  };
}

#endif // GMF16_PARSER_H
