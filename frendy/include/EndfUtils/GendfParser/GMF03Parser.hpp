#ifndef GMF03_PARSER_H
#define GMF03_PARSER_H
...
namespace frendy
{
  class GMF03Parser
  {
    ...
    public:
      ...
      vector<vector<vector<vector<Real> > > > get_NU();
      ...
      void set_NU(vector<vector<vector<vector<Real> > > > real_vec);
  };
}

#endif // GMF03_PARSER_H
