...
void MF31Writer::write_NC(int i, int j) 
{
  string         line_data;
...
void MF31Writer::write_NI(int i, int j) 
{
...
void MF31Writer::write_NI_lb00(int i, int j) 
{
  string         line_data;
  vector<string> str_vec;
...
void MF31Writer::write_NI_lb05(int i, int j) 
{
  string         line_data;
  vector<string> str_vec;
...
void MF31Writer::write_NI_lb06(int i, int j) 
{
  string         line_data;
  vector<string> str_vec;
...
vector<string> MF31Writer::get_endf_text_data(MF31Parser& MF31parser_obj)
{
  clear();
  par_obj = MF31parser_obj;
