...
//constructor
MF31Converter::MF31Converter(void)
{
}
...
void MF31Converter::convert_frendy_to_endf_format( CovarianceFissionDataContainer& frendy_obj, MF31Parser& endf_obj )
{
  //Get frendy data
...
void MF31Converter::convert_endf_format_to_frendy( MF31Parser& endf_obj, CovarianceFissionDataContainer& frendy_obj )
{
  //Get frendy data
